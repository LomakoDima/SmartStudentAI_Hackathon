...
export const translations = {
  ru: {
    ...
    profile: {
      ...
      description: 'Портфолио достижений, отслеживание прогресса и персональные рекомендации',
      averageScore: 'Средний балл',
      interestsHint: 'Ваши интересы и специализации будут отображаться здесь после заполнения профиля',
      stats: {
        coursesCompleted: 'Изучено курсов',
        goalsAchieved: 'Достигнуто целей',
        rating: 'Рейтинг',
      ...
      overview: {
        ...
        progressHint: 'Данные о прогрессе появятся здесь',
        progressSubHint: 'после начала обучения на платформе',
        recentActivity: 'Последняя активность',
        activityHint: 'История активности будет отображаться',
        activitySubHint: 'по мере использования сервисов платформы',
      },
      portfolio: {
        title: 'Мои проекты',
        hint: 'Портфолио проектов будет доступно',
        subHint: 'после добавления ваших работ',
      },
      progressTab: {
        title: 'Детальная статистика',
        hint: 'Статистика обучения появится',
        subHint: 'после прохождения курсов и выполнения заданий',
      },
      achievementsTab: {
        title: 'Достижения',
        hint: 'Ваши достижения будут отображаться здесь',
        subHint: 'по мере выполнения учебных задач и целей',
      },
      settings: {
        ...
        courseNotifications: 'Уведомления о курсах',
        courseNotificationsDesc: 'Новые материалы и задания',
        achievementNotifications: 'Уведомления о достижениях',
        achievementNotificationsDesc: 'Новые награды и прогресс',
      ...
      sidebar: {
        ...
        recommendationsHint: 'появятся на основе вашей активности',
        monthlyGoals: 'Цели на месяц',
        setGoals: 'Установите цели для',
        trackProgress: 'отслеживания прогресса',
      },
      languages: {
        russian: 'Русский',
        kazakh: 'Қазақша',
  ...
  en: {
    ...
    profile: {
      ...
      description: 'Achievement portfolio, progress tracking, and personalized recommendations',
      averageScore: 'Average Score',
      interestsHint: 'Your interests and specializations will appear here after completing your profile',
      stats: {
      ...
      overview: {
        ...
        progressHint: 'Progress data will appear here',
        progressSubHint: 'after starting learning on the platform',
        recentActivity: 'Recent Activity',
        activityHint: 'Activity history will be displayed',
        activitySubHint: 'as you use platform services',
      },
      portfolio: {
        title: 'My Projects',
        hint: 'Project portfolio will be available',
        subHint: 'after adding your work',
      },
      progressTab: {
        title: 'Detailed Statistics',
        hint: 'Learning statistics will appear',
        subHint: 'after completing courses and assignments',
      },
      achievementsTab: {
        title: 'Achievements',
        hint: 'Your achievements will be displayed here',
        subHint: 'as you complete learning tasks and goals',
      },
      settings: {
        ...
        courseNotificationsDesc: 'New materials and assignments',
        achievementNotifications: 'Achievement Notifications',
        achievementNotificationsDesc: 'New awards and progress',
        security: 'Security',
      ...
      sidebar: {
        ...
        recommendationsHint: 'will appear based on your activity',
        monthlyGoals: 'Monthly Goals',
        setGoals: 'Set goals for',
